 ...
 * Description:
 */
class NianlunDataFetch : VideoDataFetch {
    companion object {
    ...
    private val api: NianlunApi by lazy {
        mRetrofit.create(NianlunApi::class.java)
    }
...
//        "https://www.moyantv.com/index.php/vod/show/area/大陆/class/喜剧/id/1/year/2018.html"
    ...
    override fun getVideoPlayPageUrl(item: PlayLine.Item): Observable<String> {
        val videoPageUrl = (item as NianlunPlayItem).link
